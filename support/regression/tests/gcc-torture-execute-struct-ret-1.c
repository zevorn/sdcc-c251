...
char out[100];
#if !defined(__SDCC_mcs51) && !defined(__SDCC_ds390) && !defined(__SDCC_hc08) && !defined(__SDCC_s08) && !defined(SDCC_MOS) && (!defined(__SDCC_mcs251) || defined(__SDCC_STACK_AUTO)) // Static mcs51-like ABIs cannot indirect-call this parameter list.
