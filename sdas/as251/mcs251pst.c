...
/* end sdas specific */
    ...
    {	NULL,	".3byte",	S_3BYTE,	0,	0	},
    {	NULL,	".triple",	S_3BYTE,	0,	0	},
...
/*    {	NULL,	".blk4",	S_BLK,		0,	O_4BYTE	},	*/
    ...
    {   NULL,   ".source",      S_MODE,         0,      1       },
    {   NULL,   ".binary",      S_MODE,         0,      0       },
    ...
    {   NULL,   "wr6",          S_WREG,         0,      3       },
    {   NULL,   "wr8",          S_WREG,         0,      4       },
    {   NULL,   "wr10",         S_WREG,         0,      5       },
    {   NULL,   "wr12",         S_WREG,         0,      6       },
    {   NULL,   "wr14",         S_WREG,         0,      7       },
    {   NULL,   "wr16",         S_WREG,         0,      8       },
    {   NULL,   "wr18",         S_WREG,         0,      9       },
    {   NULL,   "wr20",         S_WREG,         0,      10      },
    {   NULL,   "wr22",         S_WREG,         0,      11      },
    {   NULL,   "wr24",         S_WREG,         0,      12      },
    {   NULL,   "wr26",         S_WREG,         0,      13      },
    {   NULL,   "wr28",         S_WREG,         0,      14      },
    {   NULL,   "wr30",         S_WREG,         0,      15      },
    {   NULL,   "dr0",          S_DREG,         0,      0       },
    {   NULL,   "dr4",          S_DREG,         0,      1       },
    {   NULL,   "dr8",          S_DREG,         0,      2       },
    {   NULL,   "dr12",         S_DREG,         0,      3       },
    {   NULL,   "dr16",         S_DREG,         0,      4       },
    {   NULL,   "dr20",         S_DREG,         0,      5       },
    {   NULL,   "dr24",         S_DREG,         0,      6       },
    {   NULL,   "dr28",         S_DREG,         0,      7       },
    {   NULL,   "dpx",          S_DREG,         0,      14      },
    {   NULL,   "spx",          S_DREG,         0,      15      },
    {	NULL,	"nop",		S_INH,		0,	0x00	},
    {	NULL,	"ret",		S_INH,		0,	0x22	},
    {	NULL,	"reti",		S_INH,		0,	0x32	},
    {   NULL,   "eret",          S_INH,          0,      0x1AA   },
    {   NULL,   "trap",          S_INH,          0,      0x1B9   },
    {   NULL,   "esc",           S_INH,          0,      0x0A5   },

    {	NULL,	"ajmp",		S_JMP11,	0,	0x01	},
    {	NULL,	"acall",	S_JMP11,	0,	0x11	},
    {	NULL,	"ljmp",		S_JMP16,	0,	0x02	},
    {	NULL,	"lcall",	S_JMP16,	0,	0x12	},
    {   NULL,   "ejmp",          S_JMP24,        0,      0x18A   },
    {   NULL,   "ecall",         S_JMP24,        0,      0x19A   },
    ...
    {   NULL,   "sub",          S_SUBCMP,       0,      0x190   },
    {   NULL,   "cmp",          S_SUBCMP,       0,      0x1B0   },
    ...
    {   NULL,   "movh",          S_MOVH,         0,      0       },
    {   NULL,   "movz",          S_MOVZS,        0,      0x00    },
    {   NULL,   "movs",          S_MOVZS,        0,      0x10    },
    ...
    {	NULL,	"jc",		S_BR,		0,	0x40	},
    {   NULL,   "je",            S_BR,           0,      0x168   },
    {   NULL,   "jg",            S_BR,           0,      0x138   },
    {   NULL,   "jle",           S_BR,           0,      0x128   },
    {	NULL,	"jnc",		S_BR,		0,	0x50	},
    {   NULL,   "jne",           S_BR,           0,      0x178   },
    {	NULL,	"jz",		S_BR,		0,	0x60	},
    {	NULL,	"jnz",		S_BR,		0,	0x70	},
    {   NULL,   "jsg",           S_BR,           0,      0x118   },
    {   NULL,   "jsge",          S_BR,           0,      0x158   },
    {   NULL,   "jsl",           S_BR,           0,      0x148   },
    {   NULL,   "jsle",          S_BR,           0,      0x108   },
    {	NULL,	"sjmp",		S_BR,		0,	0x80	},

    {	NULL,	"cjne",		S_CJNE,		0,	0xB0	},
    {	NULL,	"djnz",		S_DJNZ,		0,	0xD0	},
    {	NULL,	"jmp",		S_JMP,		0,	0x73	},
    {   NULL,   "call",          S_CALL,         0,      0       },
    {	NULL,	"movc",		S_MOVC,		0,	0x83	},
    {	NULL,	"movx",		S_MOVX,		0,	0x00	},
    {	NULL,	"div",		S_AB,		0,	0x84	},
    {	NULL,	"mul",		S_AB,		0,	0xA4	},
    {   NULL,   "sra",          S_SHIFT,        0,      0x10E   },
    {   NULL,   "srl",          S_SHIFT,        0,      0x11E   },
    {   NULL,   "sll",          S_SHIFT,        0,      0x13E   },
    {	NULL,	"clr",		S_ACBIT,	0,	0xC2	},
    {	NULL,	"cpl",		S_ACBIT,	0,	0xB2	},
    {	NULL,	"setb",		S_SETB,		0,	0xD2	},
    {   NULL,   "push",          S_STACK,        0,      0       },
    {   NULL,   "pop",           S_STACK,        0,      1       },
    {   NULL,   "pushw",         S_STACK,        0,      2       },
