/*-------------------------------------------------------------------------
  rtrack.c - tracking content of registers on an MCS251
...
/* move this (or mcs251_rtrackGetLit() and mcs251_rtrackMoveALit()
                  ...
                  if (s != mcs251_rtrackGetLit (s))
                    {
                      ...
                      emitcode ("mov", "dph,%s", mcs251_rtrackGetLit (s));
                      modified = true;
                      foundshortcut = 1;
                    }
                }
      ...
      if (x+1 != s)
        {
          ...
          {
            unsigned int i;
            char *ptr= mcs251_rtrackGetLit(x);
